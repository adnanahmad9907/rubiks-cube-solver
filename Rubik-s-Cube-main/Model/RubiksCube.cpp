...
//  */
// we are using notation that are commonly used in the rubiks cube world
 ...
 */
// performing a morve for each of the types
...
// performing apposite of the move of
...
{
    // perfroming random moves on the cube....
    ...
    // we also returning the moves that we have performed on the cube...
}

// Helper function returns string of corner

//  here we are following the notation that is used in the rubiks cube world
//
...
// given a corner index return the index of the corner which is currently there in the cube....
...
// given a corner index return the orientation of the corner
// orientation is the position of the corner in the cube
// 0 means it is not oriented, 1 means it is oriented in the first position and 2 means it is oriented in the second position
// we are using the notation that is used in the rubiks cube world
